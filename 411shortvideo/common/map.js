// 三个value，互不干扰，新增的按照顺序分别从50、500、3000开始  目前已经加到50、565、3223 PS：不允许出现重复value
var map = [
  {value: 1,
    label: '北京',
    children: [
      {value: 500,
        ...
        children: [
          {value: 3000, label: '城区'},
          {value: 3001, label: '城区以外'}
        ]
      },
      {value: 501,
        label: '朝阳区',
        children: [
          {value: 3002, label: '三环到四环之间'},
          {value: 3003, label: '四环到五环之间'},
          {value: 3004, label: '五环到六环之间'},
          {value: 3005, label: '管庄'},
          {value: 3006, label: '北苑'},
          {value: 3007, label: '定福庄'},
          {value: 3008, label: '三环以内'}
        ]
      },
      {value: 502,
        label: '昌平区',
        children: [
          {value: 3009, label: '六环以内'},
          {value: 3010, label: '城区'},
          {value: 3011, label: '城区以外'}
        ]
      },
      {value: 503,
        label: '平谷区',
        children: [
          {value: 3012, label: '城区'},
          {value: 3013, label: '城区以外'}
        ]
      },
      {value: 504,
        label: '海淀区',
        children: [
          {value: 3014, label: '三环以内'},
          {value: 3015, label: '三环到四环之间'},
          {value: 3016, label: '四环到五环之间'},
          {value: 3017, label: '五环到六环之间'},
          {value: 3018, label: '六环以外'},
          {value: 3019, label: '西三旗'},
          {value: 3020, label: '西二旗'}
        ]
      },
      {value: 505,
        label: '西城区',
        children: [
          {value: 3021, label: '内环到二环里'},
          {value: 3022, label: '二环到三环'}
        ]
      },
      {value: 506,
        label: '东城区',
        children: [
          {value: 3023, label: '内环到二环里'}
        ]
      },
      {value: 507,
        label: '崇文区',
        children: [
          {value: 3024, label: '一环到二环'},
          {value: 3025, label: '二环到三环'}
        ]
      },
      {value: 508,
        label: '宣武区',
        children: [
          {value: 3026, label: '内环到三环里'}
        ]
      },
      {value: 509,
        label: '丰台区',
        children: [
          {value: 3027, label: '二环到三环'},
          {value: 3028, label: '三环到四环之间'},
          {value: 3029, label: '四环到五环之间'},
          {value: 3030, label: '五环到六环之间'},
          {value: 3031, label: '六环以外'}
        ]
      },
      {value: 510,
        label: '石景山区',
        children: [
          {value: 3032, label: '四环到五环内'},
          {value: 3033, label: '石景山城区'},
          {value: 3034, label: '八大处科技园区'}
        ]
      },
      {value: 511,
        label: '门头沟',
        children: [
          {value: 3035, label: '城区'},
          {value: 3036, label: '龙泉镇'},
          {value: 3037, label: '永定镇'},
          {value: 3038, label: '大台镇'},
          {value: 3039, label: '潭柘寺镇'},
          {value: 3040, label: '王平镇'},
          {value: 3041, label: '军庄镇'},
          {value: 3042, label: '妙峰山镇'},
          {value: 3043, label: '斋堂镇'},
          {value: 3044, label: '清水镇'}
        ]
      },
      {value: 512,
        label: '房山区',
        children: [
          {value: 3045, label: '大安山乡'},
          {value: 3046, label: '大石窝镇'},
          {value: 3047, label: '窦店镇'},
          {value: 3048, label: '佛子庄乡'},
          {value: 3049, label: '韩村河镇'},
          {value: 3050, label: '河北镇'},
          {value: 3051, label: '良乡镇'},
          {value: 3052, label: '琉璃河镇'},
          {value: 3053, label: '南窑乡'},
          {value: 3054, label: '蒲洼乡'},
          {value: 3055, label: '青龙湖镇'},
          {value: 3056, label: '十渡镇'},
          {value: 3057, label: '石楼镇'},
          {value: 3058, label: '史家营乡'},
          {value: 3059, label: '霞云岭乡'},
          {value: 3060, label: '新镇'},
          {value: 3061, label: '阎村镇'},
          {value: 3062, label: '燕山地区'},
          {value: 3063, label: '张坊镇'},
          {value: 3064, label: '长沟镇'},
          {value: 3065, label: '长阳镇'},
          {value: 3066, label: '周口店镇'},
          {value: 3067, label: '城区'}
        ]
      },
      {value: 513,
        label: '通州区',
        children: [
          {value: 3068, label: '六环内（马驹桥镇）'},
          {value: 3069, label: '中仓街道'},
          {value: 3070, label: '新华街道'},
          {value: 3071, label: '玉桥街道'},
          {value: 3072, label: '北苑街道'},
          {value: 3073, label: '六环外（马驹桥镇）'},
          {value: 3074, label: '永顺镇'},
          {value: 3075, label: '梨园镇'},
          {value: 3076, label: '宋庄镇'},
          {value: 3077, label: '郭县镇'},
          {value: 3078, label: '张家湾镇'},
          {value: 3079, label: '西集镇'},
          {value: 3080, label: '永乐店镇'},
          {value: 3081, label: '潞城镇'},
          {value: 3082, label: '台湖镇'},
          {value: 3083, label: '于家务乡'},
          {value: 3084, label: '次渠镇'}
        ]
      },
      {value: 514,
        label: '延庆县',
        children: [
          {value: 3085, label: '延庆镇'},
          {value: 3086, label: '城区'},
          {value: 3087, label: '康庄镇'},
          {value: 3088, label: '八达岭镇'},
          {value: 3089, label: '永宁镇'},
          {value: 3090, label: '旧县镇'},
          {value: 3091, label: '张山营镇'},
          {value: 3092, label: '四海镇'},
          {value: 3093, label: '千家店镇'},
          {value: 3094, label: '沈家营镇'},
          {value: 3095, label: '大榆树镇'},
          {value: 3096, label: '井庄镇'},
          {value: 3097, label: '大庄科乡'},
          {value: 3098, label: '刘斌堡乡'},
          {value: 3099, label: '香营乡'},
          {value: 3100, label: '珍珠泉乡'}
        ]
      },
      {value: 515,
        label: '大兴区',
        children: [
          {value: 3101, label: '四环到五环之间'},
          {value: 3102, label: '五环到六环之间'},
          {value: 3103, label: '六环以外'},
          {value: 3104, label: '亦庄经济开发区'}
        ]
      },
      {value: 516,
        label: '顺义区',
        children: [
          {value: 3105, label: '北石槽镇'},
          {value: 3106, label: '北务镇'},
          {value: 3107, label: '北小营镇'},
          {value: 3108, label: '大孙各庄镇'},
          {value: 3109, label: '高丽营镇'},
          {value: 3110, label: '光明街道'},
          {value: 3111, label: '后沙峪地区'},
          {value: 3112, label: '空港街道'},
          {value: 3113, label: '李桥镇'},
          {value: 3114, label: '李遂镇'},
          {value: 3115, label: '龙湾屯镇'},
          {value: 3116, label: '马坡地区'},
          {value: 3117, label: '木林镇'},
          {value: 3118, label: '南彩镇'},
          {value: 3119, label: '南法信地区'},
          {value: 3120, label: '牛栏山地区'},
          {value: 3121, label: '仁和地区'},
          {value: 3122, label: '胜利街道'},
          {value: 3123, label: '石园街道'},
          {value: 3124, label: '双丰街道'},
          {value: 3125, label: '天竺地区'},
          {value: 3126, label: '旺泉街道'},
          {value: 3127, label: '杨镇地区'},
          {value: 3128, label: '张镇'},
          {value: 3129, label: '赵全营镇'}
        ]
      },
      {value: 517,
        label: '怀柔区',
        children: [
          {value: 3130, label: '城区以内'},
          {value: 3131, label: '郊外'}
        ]
      }
    ]
  ...
  {value: 2,
    ...
    children: [
      ...
      {value: 560,
        label: '津南区',
        children: [
          {value: 3144, label: '双港，辛庄'},
          {value: 3145, label: '咸水沽镇、海河教育园，海河科技园'},
          {value: 3146, label: '其他地区'}
        ]
      },
      {value: 561,
        label: '汉沽区',
        children: [
          {value: 3147, label: '汉沽区街里、汉沽开发区'},
          {value: 3148, label: '其他地区'}
        ]
      },
      {value: 562,
        label: '大港区',
        children: [
          {value: 3149, label: '大港油田'},
          {value: 3150, label: '主城区内'},
          {value: 3151, label: '主城区外'}
        ]
      },
      {value: 563,
        label: '北辰区',
        children: [
          {value: 3152, label: '外环外双街镇，河北工大新校，屈店工业园'},
          {value: 3153, label: '外环内'},
          {value: 3154, label: '外环外其他地区'}
        ]
      },
      {value: 564,
        label: '宝坻区',
        children: [
          {value: 3155, label: '城关镇、马家店开发区、天宝工业园'},
          {value: 3156, label: '其它地区'}
        ]
      },
      {value: 565,
        label: '宁河县',
        children: [
          {value: 3157, label: '芦台镇、经济开发区、贸易开发区'},
          {value: 3158, label: '其它地区'}
        ]
      }
    ]
  },
  ...
  {value: 19,
    ...
    children: [
      ...
      {value: 213,
        label: '东莞市',
        children: [
          {value: 3159, label: '长安镇'},
          {value: 3160, label: '莞城区'},
          {value: 3161, label: '南城区'},
          {value: 3162, label: '寮步镇'},
          {value: 3163, label: '大岭山镇'},
          {value: 3164, label: '横沥镇'},
          {value: 3165, label: '常平镇'},
          {value: 3166, label: '厚街镇'},
          {value: 3167, label: '万江区'},
          {value: 3168, label: '樟木头镇'},
          {value: 3169, label: '塘厦镇'},
          {value: 3170, label: '凤岗镇'},
          {value: 3171, label: '大朗镇'},
          {value: 3172, label: '东坑镇'},
          {value: 3173, label: '清溪镇'},
          {value: 3174, label: '企石镇'},
          {value: 3175, label: '茶山镇'},
          {value: 3176, label: '东城区'},
          {value: 3177, label: '虎门镇'},
          {value: 3178, label: '黄江镇'},
          {value: 3179, label: '石排镇'},
          {value: 3180, label: '道滘镇'},
          {value: 3181, label: '沙田镇'},
          {value: 3182, label: '高埗镇'},
          {value: 3183, label: '石龙镇'},
          {value: 3184, label: '石碣镇'},
          {value: 3185, label: '洪梅镇'},
          {value: 3186, label: '麻涌镇'},
          {value: 3187, label: '松山湖'},
          {value: 3188, label: '桥头镇'},
          {value: 3189, label: '望牛墩镇'},
          {value: 3190, label: '中堂镇'},
          {value: 3191, label: '谢岗镇'}
        ]},
      {value: 214,
        label: '中山市',
        children: [
          {value: 3192, label: '城区'},
          {value: 3193, label: '火炬开发区'},
          {value: 3194, label: '小榄镇'},
          {value: 3195, label: '古镇'},
          {value: 3196, label: '三乡镇'},
          {value: 3197, label: '民众镇'},
          {value: 3198, label: '东凤镇'},
          {value: 3199, label: '板芙镇'},
          {value: 3200, label: '神湾镇'},
          {value: 3201, label: '横栏镇'},
          {value: 3202, label: '港口镇'},
          {value: 3203, label: '三角镇'},
          {value: 3204, label: '大涌镇'},
          {value: 3205, label: '南头镇'},
          {value: 3206, label: '沙溪镇'},
          {value: 3207, label: '坦洲镇'},
          {value: 3208, label: '黄圃镇'},
          {value: 3209, label: '五桂山镇'},
          {value: 3210, label: '南朗镇'},
          {value: 3211, label: '沙朗镇'},
          {value: 3212, label: '皁沙镇'},
          {value: 3213, label: '东升镇'}
        ]},
      {value: 215,
        label: '潮州市',
        children: [
  ...
  {value: 28,
    ...
    children: [
      ...
      {value: 299,
        label: '嘉峪关市',
        children: [
          {value: 3214, label: '长城区'},
          {value: 3215, label: '镜铁区'},
          {value: 3216, label: '雄关区'}
        ]},
      {value: 300,
        label: '金昌市',
        children: [
  ...
  {value: 31,
    ...
    children: [
      ...
      {value: 339, label: '石河子市', children: [{value: 3217, label: '石河子市'}]},
      {value: 340, label: '阿拉尔市', children: [{value: 3218, label: '阿拉尔市'}]},
      {value: 341, label: '图木舒克市', children: [{value: 3219, label: '图木舒克市'}]},
      {value: 342, label: '五家渠市', children: [{value: 3220, label: '五家渠市'}]}
    ]},
  {value: 32,
    label: '香港',
    children: [
      {value: 343, label: '香港', children: [{value: 3221, label: '香港特别行政区'}]}
    ]},
  {value: 33,
    label: '澳门',
    children: [
      {value: 344, label: '澳门', children: [{value: 3222, label: '澳门特别行政区'}]}
    ]},
  {value: 34,
    label: '台湾',
    children: [
      {value: 345, label: '台湾', children: [{value: 3223, label: '台湾'}]}
    ]}
