        ...
        <view class="vlog-list">
          <view class="vlog-cover" v-for="vlog in publicVlogList" :key="vlog.id">
            ...
            <video style="width: 100%;height: 100%; float: left;position: absolute;" :src="vlog.url" :controls="false"
              :show-progress="false" :custom-cache="false" :http-cache="true" :page-gesture="false"
              :show-fullscreen-btn="false" :show-play-btn="false" :show-loading="false" :show-center-play-btn="false"
          ...
          success: (res) => {
            ...
            uni.request({
              ...
              success: (res) => {
                ...
                // if (this.userInfo.bgImg == null) {
                  this.userInfo.bgImg = "/static/img/me/me/1.jpg"
                // }
              }
            })
